<%-- 
    ...
    Created on : Jan 22, 2023, 12:07:29 PM
    Author     : DC
--%>
...
<% 
 ...
 String host = "";
    ...
    pst = con.prepareStatement("update leaveemp set Status='Approved' where LID='"+lid+"'");
    pst.executeUpdate();
%>       
...
String peid = "select * from leaveemp where LID='"+lid+"'";
    ...
    to = pemaidd;
     ...
     messg = "Leave Application with leave ID "+lid+" got Approved";
    from = "youremailid@gmail.com";  // write your email id
     pass = "password";      // its password
     host = "smtp.gmail.com";
            }}}
